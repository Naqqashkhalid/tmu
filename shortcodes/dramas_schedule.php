...
function dramas_schedule($atts=[]){
	...
	$monday = $wpdb->get_results("SELECT drama.`ID`,drama.`schedule_timestamp`,drama.`schedule_time`,drama.`total_average_rating`,drama.`total_vote_count` FROM $table_name as drama $post_join $tax_query WHERE $where $channel_query AND `schedule_day` LIKE '%Monday%' ORDER BY `schedule_timestamp` ASC");
	$tuesday = $wpdb->get_results("SELECT drama.`ID`,drama.`schedule_timestamp`,drama.`schedule_time`,drama.`total_average_rating`,drama.`total_vote_count` FROM $table_name as drama $post_join $tax_query WHERE $where $channel_query AND `schedule_day` LIKE '%Tuesday%' ORDER BY `schedule_timestamp` ASC");
	$wednesday = $wpdb->get_results("SELECT drama.`ID`,drama.`schedule_timestamp`,drama.`schedule_time`,drama.`total_average_rating`,drama.`total_vote_count` FROM $table_name as drama $post_join $tax_query WHERE $where $channel_query AND `schedule_day` LIKE '%Wednesday%' ORDER BY `schedule_timestamp` ASC");
	$thursday = $wpdb->get_results("SELECT drama.`ID`,drama.`schedule_timestamp`,drama.`schedule_time`,drama.`total_average_rating`,drama.`total_vote_count` FROM $table_name as drama $post_join $tax_query WHERE $where $channel_query AND `schedule_day` LIKE '%Thursday%' ORDER BY `schedule_timestamp` ASC");
	$friday = $wpdb->get_results("SELECT drama.`ID`,drama.`schedule_timestamp`,drama.`schedule_time`,drama.`total_average_rating`,drama.`total_vote_count` FROM $table_name as drama $post_join $tax_query WHERE $where $channel_query AND `schedule_day` LIKE '%Friday%' ORDER BY `schedule_timestamp` ASC");
	$saturday = $wpdb->get_results("SELECT drama.`ID`,drama.`schedule_timestamp`,drama.`schedule_time`,drama.`total_average_rating`,drama.`total_vote_count` FROM $table_name as drama $post_join $tax_query WHERE $where $channel_query AND `schedule_day` LIKE '%Saturday%' ORDER BY `schedule_timestamp` ASC");
	$sunday = $wpdb->get_results("SELECT drama.`ID`,drama.`schedule_timestamp`,drama.`schedule_time`,drama.`total_average_rating`,drama.`total_vote_count` FROM $table_name as drama $post_join $tax_query WHERE $where $channel_query AND `schedule_day` LIKE '%Sunday%' ORDER BY `schedule_timestamp` ASC");
