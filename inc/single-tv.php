...
// 		$table_col = $post_type === 'tv' ? 'tv_series' : 'dramas';
    ...
    if (current_user_can('administrator')) {
        $data .= '<div class="edit-credits-btn-container">';
        $data .= '<button class="edit-credits-btn">Edit Cast & Crew</button>';
        $data .= '</div>';

        $data .= '<div id="credits-modal" class="credits-modal">
				<div class="modal-content_2">
					<span class="close-modal">&times;</span>
					<h2>Edit Cast & Crew</h2>
					
					<ul class="nav_tabs credits-tabs">
						<li class="tab_item active" data-tab="cast">Cast</li>
						<li class="tab_item" data-tab="crew">Crew</li>
					</ul>
					
					<div id="cast-tab" class="tab-content active">
						<button class="add-credit-btn" data-type="cast">Add Cast Member</button>
						<div class="add-credit-form cast-form" style="display:none;">
							<div class="form-row">
								<input type="text" class="person-search" placeholder="Search person...">
								<input type="text" class="role-input" placeholder="Role">
							</div>
							<button class="save-credit-btn">Add</button>
						</div>
						<div class="credits-list cast-list"></div>
					</div>
					
					<div id="crew-tab" class="tab-content">
						<button class="add-credit-btn" data-type="crew">Add Crew Member</button>
						<div class="add-credit-form crew-form" style="display:none;">
							<div class="form-row">
								<input type="text" class="person-search" placeholder="Search person...">
								<select class="department-select">
									<option value="">Select Department</option>
								</select>
								<select class="job-input">
									<option value="">Select Job</option>
								</select>
							</div>
							<button class="save-credit-btn">Add</button>
						</div>
						<div class="credits-list crew-list"></div>
					</div>
				</div>
			</div>';
    }
