...
function person_header($post_id, $person){
  ...
  $data .= '<div class="feature-image" data-gallery-id="img-1" onclick="featureImage(this)"><img ' . (has_post_thumbnail() ? ('src="' . get_the_post_thumbnail_url(get_the_ID(), 'large') . '" srcset="' . wp_get_attachment_image_srcset(get_post_thumbnail_id(get_the_ID()), 'large') . '" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw" alt="' . $person['name'] . '" loading="eager" width="100%" height="100%"') : ('src="' . plugin_dir_url(__DIR__) . 'src/images/no-poster.webp" loading="eager"')) . '>';
