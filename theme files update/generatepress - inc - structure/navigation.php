		...
		<nav <?php generate_do_attr( 'navigation' ); ?>>
			<div <?php generate_do_attr( 'inside-navigation' ); ?>>
				...
				<style type="text/css">
					...
					.navigation-search { width: calc(100% - 504px); margin: 10px 0; }
					...
					input[type="search"]:focus, input[type="search"]:active { border-color: #f9731699!important  } input:focus{ outline: none; }
